...
public abstract class Auto implements MantenimientoMecanico, Archivo {
	...
	public void setPatente(Patente patente) {
		try {
			if (patente == null) {
				...
				throw new Exception("La patente debe contener 8 caracteres");
			}
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public void setPuestos(Integer puestos) throws Exception {
		if (puestos == null) {
			throw new Exception("El Auto debe poseer puestos");
		} else if (puestos < 1) {
			throw new Exception("Solo esta permitido que el Auto tenga 1 o mas puestos");
		}
		this.puestos = puestos;
	}
