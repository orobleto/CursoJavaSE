...
import com.educacionIT.javase.comparadores.OrdenPatenteDescendente;
...
public class ObjetosPropiosTreeMap {
	public static void main(String[] args) {
		...
		// se implementa la interfaz comparable para el orden natural de las patentes
		Map<Patente, Auto> autos = new TreeMap<>();

		// se crea un Comparator para un orden alternativo
		Map<Patente, Auto> autos2 = new TreeMap<>(new OrdenPatenteDescendente());
