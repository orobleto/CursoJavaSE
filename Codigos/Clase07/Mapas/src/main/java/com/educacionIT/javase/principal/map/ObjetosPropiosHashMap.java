...
public class ObjetosPropiosHashMap {
	public static void main(String[] args) {
		...
		Map<Patente, Auto> autos = new LinkedHashMap<>();
		Map<Patente, Auto> autos2 = new LinkedHashMap<>();

		// agrega objetos al mapa
		// en este ejemplo estamos colocando como clave un objeto propio pero podemos
		// seguir utilizando cualquier envoltorio o la clase string para este fin
