 ...
 * @author EducacionIT
 * @class Auto
 * @date 10 jun. 2020 Clase con modificador de acceso publico y sus metodos con
 *       el mismo modificador de acceso. Atributos privados para garantizar
 *       seguridad y estandar, podemos modificar y obtener sus valores a traves
 *       de los getter y setter (Encapsulamiento)
 */
public class Auto {
	...
	public String mostrarDatos() {
		String mensaje = "El Auto de la concesionaria " + concesionaria + " es de color " + color + ", marca "
				+ marca + ", patente " + patente + " y se encuentra " + ((encendido) ? "encendido" : "apagado");
