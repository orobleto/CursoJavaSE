package com.educacionIT.javase.entidades.porDefecto;

/**
 * @author EducacionIT
 * @class App
 * @date 10 jun. 2020
 * clase para poder instanciar objetos de tipo auto con clase por defecto y miembros de instancia (atributos y metodos) por defecto
 */
public class AppPorDefecto {
	public static void main(String[] args) {
		// declaramos el objeto auto1 y lo instanciamos de la Clase Auto del paquete com.educacionIT.javase.entidades.porDefecto
		Auto auto1 = new Auto();

		// declaramos el objeto auto2 y lo instanciamos de la Clase Auto con valores del paquete com.educacionIT.javase.entidades.porDefecto
		// iniciales
