...
import com.educacionIT.javase.entidades.publicos.Auto;

/**
 * @author EducacionIT
 * @class App
 * @date 10 jun. 2020
 * clase para poder instanciar objetos de tipo auto con clase publica y miembros de instancia (atributos y metodos) con el mismo modificador de acceso
 */
public class App {

	public static void main(String[] args) {
		// declaramos el objeto auto1 y lo instanciamos de la Clase Auto del paquete
		// com.educacionIT.javase.entidades.publicos
		Auto auto1 = new Auto();

		// declaramos el objeto auto2 y lo instanciamos de la Clase Auto con valores del
		// paquete com.educacionIT.javase.entidades.publicos
		// iniciales
